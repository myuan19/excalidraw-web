...
const DATA_DIR = process.env.EXCALIDRAW_DATA_DIR || join(__dirname, "data");
...
for (const statement of [
  "ALTER TABLE archives ADD COLUMN content_sha256 TEXT",
  "ALTER TABLE files ADD COLUMN content_sha256 TEXT",
  "ALTER TABLE files ADD COLUMN kind TEXT NOT NULL DEFAULT 'excalidraw'",
  "ALTER TABLE files ADD COLUMN folder_id TEXT",
  "ALTER TABLE files ADD COLUMN sort_index INTEGER NOT NULL DEFAULT 0",
  "ALTER TABLE library_items ADD COLUMN sort_index INTEGER NOT NULL DEFAULT 0",
  "ALTER TABLE embed_tokens ADD COLUMN usage_count INTEGER NOT NULL DEFAULT 0",
]) {
  try {
    db.exec(statement);
  } catch {
