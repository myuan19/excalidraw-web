...
| `apps/web/data/thumbnailSvg.ts` | Thumbnail SVG post-process |
...
- `apps/web/embed/embedPreviewRange.source.test.ts`
- `apps/web/data/thumbnailSvg.test.ts`
- `apps/web/data/embedDocument.test.ts`
