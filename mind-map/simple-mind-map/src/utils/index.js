...
export const getDataFromClipboard = async () => {
  ...
  if (navigator.clipboard && typeof navigator.clipboard.read === 'function') {
    try {
      ...
      console.log('[DEBUG] mindmap-paste | browser clipboard read', {
        hasText: !!text,
      ...
      console.log('[DEBUG] mindmap-paste | browser clipboard read failed', {
        name: error?.name,
  ...
  if (window.takeOverAppMethods?.readClipboardItems) {
    ...
    console.log('[DEBUG] mindmap-paste | host clipboard read', {
