export default {
  ...
  richTextToolbar: {
    ...
    selectNodeHint: '请先选中一个节点',
    applyToAll: '将应用于节点全部文字',
    showFloatingToolbar: '划选文字时显示浮动工具栏'
  },
  other: {
    loading: '正在加载，请稍后...'
  },
  ...
  ai: {
    ...
    aiCreatingOperationBlocked: 'AI 生成中仅支持查看、拖动画布和展开/收起节点',
    ...
    promptPresetInsertTip: '点击插入到上方表单，不会保持选中',
    ...
    allowCreateChildren: '允许新增子节点',
    allowCreateChildrenTip: '开启后 AI 才能新增子节点；默认关闭。',
    allowDeleteNodes: '允许删除节点',
    allowDeleteNodesTip: '开启后 AI 才能删除子节点；默认关闭，防止误删。',
    ...
    savedPromptPresetsGlobalTip: '仅保存提示词与配置，不绑定节点',
