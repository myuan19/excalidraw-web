  ...
  <div class="toolbarContainer" :class="{ isDark: isDark }">
    <div class="toolbar" ref="toolbarRef">
      ...
      <div class="toolbarBlock">
        ...
        <div class="hostSaveHint" v-if="isHostMode && hostSaveStatusText">
          {{ hostSaveStatusText }}
        </div>
      </div>
      <div class="toolbarBlock middleToolbarBlock" v-if="fileTreeVisible">
        <!-- 本地文件树 -->
        <div class="fileTreeBox" :class="{ expand: fileTreeExpand }">
