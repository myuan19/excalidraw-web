...
export default {
  ...
  computed: {
    ...mapState({
      ...
      showRichTextToolbarOnSelection: state =>
        state.localConfig.showRichTextToolbarOnSelection
    }),
  ...
  methods: {
    onRichTextSelectionChange(hasRange, rect, formatInfo) {
      ...
      this.showRichTextToolbar = hasRange && !!this.showRichTextToolbarOnSelection
    },
