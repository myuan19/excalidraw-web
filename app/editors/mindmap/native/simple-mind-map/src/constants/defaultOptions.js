  ...
  */
  ...
  ...(() => {
    const {
      maxFileBytes,
      maxDimension,
    } = require('../../../../../../../packages/common/editor-media-limits.cjs')
    return {
      maxNodeImageStorageWidth: maxDimension,
      maxNodeImageStorageHeight: maxDimension,
      maxNodeImageStorageBytes: maxFileBytes,
    }
  })(),
